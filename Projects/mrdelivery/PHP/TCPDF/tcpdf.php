...
class TCPDF {
	...
	/**
		מדפיס תא (שטח מלבני) עם גבולות אופציונליים, צבע רקע ומחרוזת תווים. הפינה 
		השמאלית העליונה של התא תואמת את המיקום הנוכחי. ניתן ליישר את הטקסט או
		למרכזו. לאחר השיחה המיקום הנוכחי עובר ימינה או לקו הבא. אפשר לשים קישור לטקסט. <br />
		אם הפעלת עמוד אוטומטית מופעלת והתא חורג מהגבול, מעבר עמוד מתבצע לפני ההפקה.
		
	* @param $w (float) רוחב התא. אם 0, התא משתרע עד לשוליים הימניים.
	* @param $h (float)   גובה התא. ערך ברירת מחדל: 0.
	* @param $txt (string)  מחרוזת להדפסה. ערך ברירת מחדל: מחרוזת ריקה.
	...
	*/
	...
	public function Output($name='doc.pdf', $dest='') {
		...
		switch($dest) {
		 case 'I': {    //  8.6.21   -  הוספתי את זה בשביל שיהיה ניתן לראות אישור מסירה לדוגמא 
