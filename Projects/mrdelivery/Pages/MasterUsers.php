...
<div   class="wrapper"  >   
<div class="title">צפיה בכל המשתמשים - 

<?php
require_once "../PHP/dbClass.php";
$db = new dbClass();

$CountRegisteredUsers=$db->CountRegisteredUsers();  

echo "מס' משתמשים רשומים:   $CountRegisteredUsers "; 
?>  
